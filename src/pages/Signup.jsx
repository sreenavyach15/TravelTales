...
import { PASSWORD_REQUIREMENTS, validateSignupForm } from '../services/authValidation'
...
function Signup() {
  ...
  return (
    <PageContainer title="Signup" description="Create your Travel Tales account to start planning trips.">
